...
source(paste0(path_wd,"04_code/Code_self/","Multi_replicate_simulation.R"))
source(paste0(path_wd,"04_code/Code_self/","determine parameters.R"))
source(paste0(path_wd,"04_code/Code_self/","deterministic_SIR.R"))
